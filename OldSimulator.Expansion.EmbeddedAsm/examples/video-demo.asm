; Open16A guest demo: full-screen pixel animation driven by the keyboard.
;
; This is a standalone guest program for the main machine (not card firmware):
;   Open16A-ASM video-demo.asm -c -o video-demo.o16o
;   Open16A-LD video-demo.o16o --base 0300h -o video-demo.bin
; then load it with the host debugger `loadrun "video-demo.bin" 0300h`.
;
; Arrow keys move the cursor; LeftShift/LeftControl/RightShift/RightControl
; choose the color; the four-space navigation selects Escape.
